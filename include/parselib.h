...
class Parse_Exception : public std::runtime_error {
	...
	public:
		Parse_Exception(const char* msg, const std::string cur_func, const std::string func_traceback) : std::runtime_error(msg) {
			this->traceback = "";
			this->traceback += cur_func;
			this->traceback += traceback;
		}
		void what_func() { std::cerr << WHAT_FUNC_MSG_START << this->traceback << "\n";}
};
